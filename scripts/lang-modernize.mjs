...
const MAP = [
  ...
  ['कार्यशील पूंजी', 'वर्किंग कैपिटल'],      // anusvara variant
  ['कार्यशील कैपिटल', 'वर्किंग कैपिटल'],      // cleanup: half-modernized → full common term
  ['चुकता पूंजी', 'पेड-अप कैपिटल'],
  ['चुकता कैपिटल', 'पेड-अप कैपिटल'],
  ['अधिकृत पूंजी', 'ऑथराइज़्ड कैपिटल'],
  ['निर्गमित पूंजी', 'इश्यूड कैपिटल'],
  ...
  ['प्राप्ति', 'रसीद'],
  // — pass 3: more shuddh → common (Sitaram flagged अवशिष्ट / वैधानिक) —
  ['वैधानिक संचय निधि', 'रिज़र्व फंड'],
  ['वैधानिक संचय', 'रिज़र्व फंड'],
  ['संचय निधि', 'रिज़र्व फंड'],
  ['अवशिष्ट मूल्य', 'सैल्वेज वैल्यू'],
  ['अवशिष्ट', 'सैल्वेज'],
  ['अवितरित अधिशेष', 'बिना बाँटा सरप्लस'],
  ['शुद्ध अधिशेष', 'नेट सरप्लस'],
  ['अधिशेष', 'सरप्लस'],
  ['सांविधिक', 'कानूनी'],
  ['वैधानिक', 'कानूनी'],
  ['त्रैमासिक', 'क्वार्टरली'],
  ['प्रविष्टियों', 'एंट्रियों'],
  ['प्रविष्टियाँ', 'एंट्रियाँ'],
  ['प्रविष्टियां', 'एंट्रियां'],
  ['प्रविष्टि', 'एंट्री'],
  ['स्तंभ', 'कॉलम'],
  ['संचय', 'रिज़र्व'],
  ['निधि', 'फंड'],
  ['मूल्यांकन', 'वैल्यूएशन'],
  ['विनियोग', 'बँटवारा'],
  // NOTE: 'अनुलग्नक' (NCDC अनुलग्नक-I/V) and 'प्रारूप' intentionally NOT mapped — statutory format names.
];
