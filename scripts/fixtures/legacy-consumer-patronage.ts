 ...
 */
type PatronageLine = { memberId: string; memberName: string; base: number; amount: number };
type DairyDistributionLine = PatronageLine; type DairyBonusBasis = 'per_litre' | 'per_value'; type MilkEntry = { date: string; memberId: string; memberName?: string; qty: number; amount: number; qualityDecision?: string };
