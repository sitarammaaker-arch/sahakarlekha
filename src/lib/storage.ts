...
export const CMS_SOCIETY_ACCOUNTS: LedgerAccount[] = [
  ...
  { id: '1209', name: 'Price Stabilization Fund',   nameHi: 'मूल्य स्थिरता निधि',       type: 'equity',    openingBalance: 0, openingBalanceType: 'credit', isSystem: false, isGroup: false, parentId: '1200' },
  { id: '1210', name: 'Social / Cooperative Dev Fund', nameHi: 'सहकारी विकास निधि',    type: 'equity',    openingBalance: 0, openingBalanceType: 'credit', isSystem: false, isGroup: false, parentId: '1200' },
  { id: '1211', name: 'Dividend Distribution',      nameHi: 'लाभांश वितरण',             type: 'equity',    openingBalance: 0, openingBalanceType: 'debit',  isSystem: false, isGroup: false, parentId: '1200' },
  ...
  { id: '2207', name: 'Professional Tax Payable',   nameHi: 'देय व्यावसायिक कर',        type: 'liability', openingBalance: 0, openingBalanceType: 'credit', isSystem: false, isGroup: false, parentId: '2200' },
  { id: '2208', name: 'Interest Payable',           nameHi: 'देय ब्याज',                type: 'liability', openingBalance: 0, openingBalanceType: 'credit', isSystem: false, isGroup: false, parentId: '2100' },
  { id: '2209', name: 'Audit Fee Payable',          nameHi: 'देय लेखा परीक्षण शुल्क',   type: 'liability', openingBalance: 0, openingBalanceType: 'credit', isSystem: false, isGroup: false, parentId: '2100' },
  { id: '2210', name: 'Advance from Members',       nameHi: 'सदस्यों से अग्रिम',        type: 'liability', openingBalance: 0, openingBalanceType: 'credit', isSystem: false, isGroup: false, parentId: '2100' },
  ...
  { id: '2305', name: 'KCC / Crop Loan (DCCB)',     nameHi: 'KCC / फसल ऋण (DCCB)',      type: 'liability', openingBalance: 0, openingBalanceType: 'credit', isSystem: false, isGroup: false, parentId: '2300' },
  ...
  { id: '3207', name: 'NSC / Post Office Deposits', nameHi: 'NSC / डाकघर जमा',          type: 'asset',     openingBalance: 0, openingBalanceType: 'debit',  isSystem: false, isGroup: false, parentId: '3200' },
  { id: '3208', name: 'Cooperative Society Shares', nameHi: 'सहकारी समिति शेयर',        type: 'asset',     openingBalance: 0, openingBalanceType: 'debit',  isSystem: false, isGroup: false, parentId: '3200' },
  ...
  { id: '3313', name: 'Member Loan Interest Rec.',  nameHi: 'सदस्य ऋण ब्याज प्राप्य',   type: 'asset',     openingBalance: 0, openingBalanceType: 'debit',  isSystem: false, isGroup: false, parentId: '3300' },
  { id: '3314', name: 'Commission Receivable',      nameHi: 'प्राप्य कमीशन',             type: 'asset',     openingBalance: 0, openingBalanceType: 'debit',  isSystem: false, isGroup: false, parentId: '3300' },
  { id: '3315', name: 'Advance to Employees',       nameHi: 'कर्मचारियों को अग्रिम',     type: 'asset',     openingBalance: 0, openingBalanceType: 'debit',  isSystem: false, isGroup: false, parentId: '3300' },
  { id: '3316', name: 'Stock in Transit',           nameHi: 'पारगमन में माल',            type: 'asset',     openingBalance: 0, openingBalanceType: 'debit',  isSystem: false, isGroup: false, parentId: '3300' },
  ...
  { id: '3406', name: 'Packing Material',           nameHi: 'पैकिंग सामग्री',            type: 'asset',     openingBalance: 0, openingBalanceType: 'debit',  isSystem: false, isGroup: false, parentId: '3400' },
  ...
  { id: '4207', name: 'Storage / Cold Storage Income', nameHi: 'गोदाम / शीत भंडार आय', type: 'income',    openingBalance: 0, openingBalanceType: 'credit', isSystem: false, isGroup: false, parentId: '4200' },
  { id: '4208', name: 'Service Charges',            nameHi: 'सेवा प्रभार',              type: 'income',    openingBalance: 0, openingBalanceType: 'credit', isSystem: false, isGroup: false, parentId: '4200' },
  ...
  { id: '4304', name: 'PM Kisan / DBT Income',     nameHi: 'पीएम किसान / DBT आय',      type: 'income',    openingBalance: 0, openingBalanceType: 'credit', isSystem: false, isGroup: false, parentId: '4300' },
  { id: '4305', name: 'FPO / Farmer Group Income', nameHi: 'FPO / कृषक समूह आय',       type: 'income',    openingBalance: 0, openingBalanceType: 'credit', isSystem: false, isGroup: false, parentId: '4300' },
  ...
  { id: '4408', name: 'Interest on Member Loans',  nameHi: 'सदस्य ऋण पर ब्याज',        type: 'income',    openingBalance: 0, openingBalanceType: 'credit', isSystem: false, isGroup: false, parentId: '4400' },
  { id: '4409', name: 'Bad Debt Recovery',          nameHi: 'अशोध्य ऋण वसूली',          type: 'income',    openingBalance: 0, openingBalanceType: 'credit', isSystem: false, isGroup: false, parentId: '4400' },
  { id: '4410', name: 'Profit on Sale of Assets',  nameHi: 'संपत्ति बिक्री पर लाभ',    type: 'income',    openingBalance: 0, openingBalanceType: 'credit', isSystem: false, isGroup: false, parentId: '4400' },
  ...
  { id: '5206', name: 'Gratuity Provision',         nameHi: 'उपदान प्रावधान',             type: 'expense',   openingBalance: 0, openingBalanceType: 'debit',  isSystem: false, isGroup: false, parentId: '5200' },
  { id: '5207', name: 'Employee Bonus',             nameHi: 'कर्मचारी बोनस',             type: 'expense',   openingBalance: 0, openingBalanceType: 'debit',  isSystem: false, isGroup: false, parentId: '5200' },
  { id: '5208', name: 'HRA / DA Allowance',         nameHi: 'HRA / DA भत्ता',            type: 'expense',   openingBalance: 0, openingBalanceType: 'debit',  isSystem: false, isGroup: false, parentId: '5200' },
  ...
  { id: '5312', name: 'Advertisement',              nameHi: 'विज्ञापन व्यय',             type: 'expense',   openingBalance: 0, openingBalanceType: 'debit',  isSystem: false, isGroup: false, parentId: '5300' },
  { id: '5313', name: 'Postage / Courier',          nameHi: 'डाक / कूरियर व्यय',         type: 'expense',   openingBalance: 0, openingBalanceType: 'debit',  isSystem: false, isGroup: false, parentId: '5300' },
  ...
  { id: '5315', name: 'Filing / Registration Fees', nameHi: 'दाखिल / पंजीकरण शुल्क',    type: 'expense',   openingBalance: 0, openingBalanceType: 'debit',  isSystem: false, isGroup: false, parentId: '5300' },
  ...
  { id: '5404', name: 'Bad Debt Written Off',       nameHi: 'अशोध्य ऋण अपलेखन',         type: 'expense',   openingBalance: 0, openingBalanceType: 'debit',  isSystem: false, isGroup: false, parentId: '5400' },
  { id: '5405', name: 'Donation / CSR',             nameHi: 'दान / CSR व्यय',            type: 'expense',   openingBalance: 0, openingBalanceType: 'debit',  isSystem: false, isGroup: false, parentId: '5400' },
  { id: '5406', name: 'Loss on Sale of Assets',     nameHi: 'संपत्ति बिक्री पर हानि',   type: 'expense',   openingBalance: 0, openingBalanceType: 'debit',  isSystem: false, isGroup: false, parentId: '5400' },
  { id: '5407', name: 'Prior Period Adjustments',   nameHi: 'पूर्व अवधि समायोजन',        type: 'expense',   openingBalance: 0, openingBalanceType: 'debit',  isSystem: false, isGroup: false, parentId: '5400' },
  ...
  { id: '5604', name: 'Interest on Borrowings',     nameHi: 'उधार पर ब्याज व्यय',       type: 'expense',   openingBalance: 0, openingBalanceType: 'debit',  isSystem: false, isGroup: false, parentId: '5600' },
  { id: '5605', name: 'Penalty / Fine',             nameHi: 'जुर्माना / दंड व्यय',      type: 'expense',   openingBalance: 0, openingBalanceType: 'debit',  isSystem: false, isGroup: false, parentId: '5600' },
