...
export const CMS_SOCIETY_ACCOUNTS: LedgerAccount[] = [
  ...
  { id: '3201', name: 'Hafed Share',                nameHi: 'हैफेड शेयर',               type: 'asset',     openingBalance: 0, openingBalanceType: 'debit',  isSystem: false, isGroup: false, parentId: '3200', subtype: 'investment' },
