...
export const MODULE_CATALOG: ModuleDefinition[] = [
  ...
  { id: 'dairyRegisters', titleKey: 'dairyRegisters', icon: FileSpreadsheet, route: '/dairy-registers', domain: 'dairy', requiredCapabilities: ['dairy_collection'], requiredRoles: ['admin', 'accountant', 'viewer'], order: 3 },
