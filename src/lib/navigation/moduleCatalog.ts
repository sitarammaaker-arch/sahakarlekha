...
export const MODULE_CATALOG: ModuleDefinition[] = [
  ...
  { id: 'inventory',      titleKey: 'inventory',      icon: Boxes,           route: '/inventory',       domain: 'operations', requiredCapabilities: U, order: 1 },
  { id: 'suppliers',      titleKey: 'suppliers',      icon: Truck,           route: '/suppliers',       domain: 'operations', requiredCapabilities: U, order: 2 },
  { id: 'customers',      titleKey: 'customers',      icon: UserCheck,       route: '/customers',       domain: 'operations', requiredCapabilities: U, order: 3 },
  { id: 'sales',          titleKey: 'sales',          icon: ShoppingCart,    route: '/sales',           domain: 'operations', requiredCapabilities: U, order: 4 },
  ...
  { id: 'tradingAccount',     titleKey: 'tradingAccount',     icon: ShoppingCart,    route: '/trading-account',      domain: 'reports', requiredCapabilities: U, order: 2 },
  ...
  { id: 'saleRegister',       titleKey: 'saleRegister',       icon: ShoppingCart,    route: '/sale-register',        domain: 'reports', requiredCapabilities: U, order: 6 },
  ...
  { id: 'gstSummary',         titleKey: 'gstSummary',         icon: Percent,         route: '/gst-summary',          domain: 'reports', requiredCapabilities: U, order: 9 },
  ...
  { id: 'tdsForm16A',         titleKey: 'tdsForm16A',         icon: Receipt,         route: '/tds-form16a',          domain: 'reports', requiredCapabilities: U, order: 11 },
  { id: 'tdsRegister',        titleKey: 'tdsRegister',        icon: Receipt,         route: '/tds-register',         domain: 'reports', requiredCapabilities: U, order: 12 },
  { id: 'stockValuation',     titleKey: 'stockValuation',     icon: Warehouse,       route: '/stock-valuation',      domain: 'reports', requiredCapabilities: U, order: 13 },
  { id: 'closingStockReport', titleKey: 'closingStockReport', icon: Package,         route: '/closing-stock-report', domain: 'reports', requiredCapabilities: U, order: 14 },
  { id: 'budgetModule',       titleKey: 'budgetModule',       icon: PiggyBank,       route: '/budget-module',        domain: 'reports', requiredCapabilities: U, order: 15 },
  { id: 'eWayBill',           titleKey: 'eWayBill',           icon: FileJson,        route: '/eway-bill',            domain: 'reports', requiredCapabilities: U, order: 16 },
  { id: 'hsnMaster',          titleKey: 'hsnMaster',          icon: Hash,            route: '/hsn-master',           domain: 'reports', requiredCapabilities: U, order: 17 },
  { id: 'nabardReport',       titleKey: 'nabardReport',       icon: Landmark,        route: '/nabard-report',        domain: 'reports', requiredCapabilities: U, order: 18 },
  { id: 'federationReport',   titleKey: 'federationReport',   icon: ScrollText,      route: '/federation-report',    domain: 'reports', requiredCapabilities: U, order: 19 },
  { id: 'recoverables',       titleKey: 'recoverables',       icon: ScrollText,      route: '/recoverables',         domain: 'reports', requiredCapabilities: U, order: 20 },
  { id: 'kachiAarat',         titleKey: 'kachiAarat',         icon: ScrollText,      route: '/kachi-aarat',          domain: 'reports', requiredCapabilities: U, order: 21 },
  ...
  { id: 'loanRegister',         titleKey: 'loanRegister',         icon: Landmark,     route: '/loan-register',         domain: 'registers', requiredCapabilities: U, order: 1 },
  { id: 'loanInterest',         titleKey: 'loanInterest',         icon: Percent,      route: '/loan-interest',         domain: 'registers', requiredCapabilities: U, requiredRoles: ['admin', 'accountant'], order: 2 },
  ...
  { id: 'kccLoan',              titleKey: 'kccLoan',              icon: Wheat,        route: '/kcc-loan',              domain: 'registers', requiredCapabilities: U, order: 14 },
