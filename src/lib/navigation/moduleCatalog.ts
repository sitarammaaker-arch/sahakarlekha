...
export const MODULE_CATALOG: ModuleDefinition[] = [
  ...
  { id: 'deposits',             titleKey: 'deposits',             icon: PiggyBank,    route: '/deposits',              domain: 'registers', requiredCapabilities: ['deposit_ledger'], order: 2.5 },   // T-13 (CAP-1): gate on the deposit capability, not a borrowed 'lending'. Empty-diff across all 11 type templates (same set holds both), but now a deposit-only entitlement resolves correctly.
  ...
  { id: 'branches',                   titleKey: 'branches',                   icon: Building2,       route: '/branches',                     domain: 'administration', requiredCapabilities: U, order: 2.5 },
  { id: 'godowns',                    titleKey: 'godowns',                    icon: Warehouse,       route: '/godowns',                      domain: 'administration', requiredCapabilities: ['inventory_sales'], order: 2.6 },
