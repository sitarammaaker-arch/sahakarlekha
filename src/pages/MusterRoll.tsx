        ...
        <CardContent className="space-y-2">
          ...
          {unpaidRows.length > 0 && (
            <div className="space-y-2 border-t pt-3">
              ...
              <p className="text-xs text-muted-foreground">{hi ? 'अभुगतान मज़दूरी स्वतः “देय मज़दूरी” (देयता) के रूप में खातों में दर्ज है — Balance Sheet व I&E में दिखेगी।' : 'Unpaid wages are auto-booked as a “Wages Payable” liability — visible in Balance Sheet & I&E.'}</p>
            </div>
          )}
