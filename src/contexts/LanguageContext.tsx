...
export const translations: Translations = {
  ...
  statutoryReconciliation: { hi: 'सांविधिक मिलान (PF/ESI)', en: 'Statutory Reconciliation' },
  ...
  agingAnalysis: { hi: 'बकाया विश्लेषण (वसूली/भुगतान)', en: 'Aging Analysis' },
  ...
  amc: { hi: 'रखरखाव अनुबंध (AMC)', en: 'AMC / Contracts' },
  ...
  salesReturn: { hi: 'Credit Note (बिक्री वापसी)', en: 'Credit Note (Sales Return)' },
  purchaseReturn: { hi: 'Debit Note (खरीद वापसी)', en: 'Debit Note (Purchase Return)' },
