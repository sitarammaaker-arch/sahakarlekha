...
- उस पर किसका कितना हक़ (देयता/पूँजी) है,
...
2. **देयता (Liabilities)** — जो समिति को चुकाना है: जमा, लिया गया ऋण, बकाया भुगतान।
3. **पूँजी (Capital)** — सदस्यों की शेयर पूँजी व संचित निधि।
...
| देयता, पूँजी व आय | Credit (Cr) | Debit (Dr) |

> 🔍 उदाहरण: सदस्य से ₹5,000 शेयर पूँजी नकद मिली। नकद (संपत्ति) बढ़ा → **Cash Dr ₹5,000**; शेयर पूँजी (पूँजी) बढ़ी → **Share Capital Cr ₹5,000**। Dr = Cr, खाता संतुलित।
...
जब भी आपका तुलन-पत्र (Balance Sheet) "नहीं मिलता", तो असल में यही समीकरण कहीं टूटा होता है — अक्सर प्रारंभिक शेष (Opening Balance) में।
...
3. वाउचर से **रोज़नामचा (Day Book)** व **खाता-बही (Ledger)** बनते हैं।
4. इनसे **तलपट (Trial Balance)** — जहाँ Dr = Cr जाँचा जाता है।
5. फिर **अंतिम खाते** — Trading, Income & Expenditure, Balance Sheet।
6. वर्षांत पर **ऑडिट** व **लाभ-विनियोग**।

डिजिटल सिस्टम में आप केवल **पहला कदम** (सही वाउचर) करते हैं — बाकी चरण अपने-आप बनते हैं। यही मैनुअल और डिजिटल का सबसे बड़ा फ़र्क़ है, जिसे हमने [डिजिटल लेखांकन क्यों ज़रूरी है](/blog/sahakari-samiti-digital-lekhankan-zaroorat) में विस्तार से देखा।

## तीन आदतें जो किताबें बचाती हैं

- 🗓️ **रोज़ प्रविष्टि करें** — लेन-देन उसी दिन दर्ज हो, ढेर न लगने दें।
