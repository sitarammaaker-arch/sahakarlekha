...
export const BLOG_POSTS: BlogPost[] = [
  {
    ...
    excerpt: 'प्रवेश शुल्क बनाम शेयर पूँजी, सदस्य-बही, लाभांश और निकासी पर शेयर-वापसी — सब सही तरीके से।',
    accent: 'rose',
  ...
  },
  {
    ...
    excerpt: 'एक-सूत्र स्टॉक नियम, भारित-औसत मूल्य, और समापन-स्टॉक की एकल गणना से सही लाभ।',
    accent: 'indigo',
  ...
  },
  {
    ...
    excerpt: 'अनभुनाए चेक, बैंक प्रभार और छूटी प्रविष्टियाँ — हर अंतर पहचानकर बैंक शेष मिनटों में मिलाएँ।',
    accent: 'sky',
