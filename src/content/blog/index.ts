...
export const BLOG_POSTS: BlogPost[] = [
  ...
  },
  {
    ...
    metaTitle: 'डेबिट, क्रेडिट और दोहरा लेखा: हर एंट्री के दो पहलू | SahakarLekha',
    metaDescription: 'डेबिट (नाम) और क्रेडिट (जमा) का असली मतलब, दोहरा लेखा प्रणाली और सुनहरे नियम — उदाहरण सहित आसान हिन्दी में।',
    date: '2026-06-08',
    category: 'लेखांकन मूल बातें',
    title: 'डेबिट, क्रेडिट और दोहरा लेखा: हर एंट्री के दो पहलू',
    shortTitle: 'डेबिट, क्रेडिट व दोहरा लेखा',
    excerpt: 'हर लेन-देन के दो पक्ष — Dr और Cr। बुनियाद समझिए, हर रिपोर्ट सही बनेगी।',
    accent: 'violet',
    tags: ['डेबिट-क्रेडिट', 'दोहरा लेखा'],
  },
  {
    slug: 'accounting-equation-explained',
    metaTitle: 'लेखांकन समीकरण: परिसंपत्ति = देयता + पूँजी | SahakarLekha',
    metaDescription: 'बैलेंस शीट हमेशा क्यों मिलती है — परिसंपत्ति = देयता + पूँजी। तीनों हिस्से उदाहरण सहित आसान भाषा में।',
    date: '2026-06-07',
    category: 'लेखांकन मूल बातें',
    title: 'लेखांकन समीकरण: परिसंपत्ति = देयता + पूँजी',
    shortTitle: 'लेखांकन समीकरण',
    excerpt: 'एक समीकरण जो बैलेंस शीट का पूरा रहस्य खोल देता है — उदाहरण के साथ।',
    accent: 'amber',
    tags: ['लेखांकन समीकरण', 'बैलेंस शीट'],
  },
  {
    slug: 'cash-book-vs-bank-book',
    metaTitle: 'रोकड़ बही और बैंक बही: फर्क और सही इस्तेमाल | SahakarLekha',
    metaDescription: 'रोकड़ बही (भौतिक नकद) और बैंक बही (बैंक का पैसा) में फर्क, contra एंट्री और सबसे आम चूक से बचाव — आसान भाषा में।',
    date: '2026-06-06',
    category: 'बैंक व रिपोर्ट',
    title: 'रोकड़ बही और बैंक बही: फर्क और सही इस्तेमाल',
    shortTitle: 'रोकड़ बही vs बैंक बही',
    excerpt: 'रोकड़ और बैंक को अलग रखना सही हिसाब की पहली शर्त है — जानिए कैसे।',
    accent: 'indigo',
    tags: ['रोकड़ बही', 'बैंक बही'],
  },
  {
    slug: 'ledger-and-posting-explained',
    metaTitle: 'खाता बही और पोस्टिंग: एंट्री से शेष तक | SahakarLekha',
    metaDescription: 'खाता बही, लेजर खाता और पोस्टिंग कैसे काम करते हैं — वाउचर से खाते तक, और रोज़नामचा बनाम खाता बही का फर्क।',
    date: '2026-06-05',
    category: 'लेखांकन मूल बातें',
    title: 'खाता बही और पोस्टिंग: एंट्री से शेष तक',
    shortTitle: 'खाता बही व पोस्टिंग',
    excerpt: 'वाउचर खाता बही में कैसे पहुँचता है और हर खाते का शेष कैसे बनता है।',
    accent: 'emerald',
    tags: ['खाता बही', 'पोस्टिंग'],
  },
  {
  ...
  },
  {
    ...
    metaDescription: 'खाता समूह और खाता शीर्ष क्या हैं, सही चार्ट ऑफ़ अकाउंट्स कैसे बनाएं, और मानक नामों से रिपोर्ट साफ़ कैसे रखें।',
    date: '2026-06-03',
    category: 'लेखांकन मूल बातें',
  ...
  },
  {
    ...
    metaTitle: 'अंश पूँजी: अधिकृत, निर्गमित और चुकता का फर्क | SahakarLekha',
    metaDescription: 'अधिकृत, निर्गमित और चुकता पूँजी में फर्क, अंकित मूल्य और अंश प्रमाण-पत्र — उदाहरण सहित आसान भाषा में।',
    date: '2026-05-31',
    category: 'सदस्य व ऋण',
    title: 'अंश पूँजी: अधिकृत, निर्गमित और चुकता का फर्क',
    shortTitle: 'अंश पूँजी के प्रकार',
  ...
  },
  {
    ...
    metaDescription: 'चेक, डिमांड ड्राफ्ट, NEFT/RTGS और UPI में फर्क और सही इस्तेमाल — और हर तरीका बैंक बही में कैसे दर्ज करें।',
    date: '2026-05-30',
    category: 'बैंक व रिपोर्ट',
    title: 'बैंक भुगतान के तरीके: चेक, DD, NEFT/RTGS और UPI',
    shortTitle: 'बैंक भुगतान के तरीके',
    excerpt: 'कौन-सा तरीका कब, और हर एक को बैंक बही में सही दर्ज कैसे करें।',
    accent: 'emerald',
    tags: ['चेक', 'UPI', 'NEFT'],
  },
  {
  ...
  },
  {
    ...
    metaTitle: 'लेखांकन की बुनियादी मान्यताएँ: चालू व्यवसाय व विवेकशीलता | SahakarLekha',
    metaDescription: 'चालू व्यवसाय (going concern) और विवेकशीलता (prudence) — दो बुनियादी लेखांकन मान्यताएँ जो खाते को यथार्थवादी व भरोसेमंद बनाती हैं।',
    date: '2026-05-28',
    category: 'लेखांकन मूल बातें',
    title: 'लेखांकन की बुनियादी मान्यताएँ: चालू व्यवसाय और विवेकशीलता',
    shortTitle: 'लेखांकन की बुनियादी मान्यताएँ',
    excerpt: 'खातों के पीछे की सोच — चालू व्यवसाय व विवेकशीलता, आसान भाषा में।',
    accent: 'violet',
  ...
  },
  {
    ...
    metaTitle: 'रोकड़ संभाल और सत्यापन: नकद का सही हिसाब | SahakarLekha',
    metaDescription: 'रोकड़ बही का शेष असल नकद से कैसे मिलाएं, रोकड़ सत्यापन की आदतें और आम चूकों से बचाव — समिति की नकद हमेशा सही रखें।',
    date: '2026-05-22',
    category: 'बैंक व रिपोर्ट',
    title: 'रोकड़ संभाल और सत्यापन: नकद का सही हिसाब',
    shortTitle: 'रोकड़ संभाल व सत्यापन',
    excerpt: 'नकद में सबसे ज़्यादा गलतियाँ — अनुशासित संभाल व सत्यापन से बचाव।',
    accent: 'amber',
    tags: ['रोकड़', 'सत्यापन', 'नकद'],
  },
  {
