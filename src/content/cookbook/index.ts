...
export const COOKBOOK_ENTRIES: CookbookEntry[] = [
  ...
  {
    slug: 'subsidy-received',
    metaTitle: 'अनुदान/सब्सिडी प्राप्त होने की एंट्री — Dr/Cr | SahakarLekha',
    metaDescription: 'सरकार/NABARD से अनुदान (subsidy/grant) मिलने का journal — Dr नकद/बैंक, Cr सरकारी अनुदान (आय)। सहकारी समिति के लिए उदाहरण सहित।',
    category: 'अनुदान व अन्य आय',
    title: 'अनुदान / सब्सिडी प्राप्त (Subsidy Received)',
    intent: 'anudan subsidy mili entry',
    scenario: 'समिति को सरकार, NABARD या विभाग से अनुदान/सब्सिडी प्राप्त हुई।',
    lines: [
      { account: 'Cash / Bank (नकद / बैंक)', type: 'Dr' },
      { account: 'Govt Subsidy / सरकारी अनुदान (4303)', type: 'Cr' },
    ],
    narration: 'अनुदान प्राप्त — योजना/विभाग ___, आदेश सं. ___',
    notes: [
      'अगर अनुदान किसी संपत्ति के लिए है (capital subsidy), तो लेखा नीति अनुसार उसे संपत्ति से घटाना या पूँजी-अनुदान में रखना पड़ सकता है — शर्तें देखें।',
      'शर्त-आधारित अनुदान बाद में लौटाना पड़े तो वह अलग एंट्री होगी।',
    ],
    deepLink: { route: '/receive-payment', label: 'App में प्राप्ति दर्ज करें' },
    guideSlug: 'income-and-expenditure',
    related: ['bad-debt-recovery', 'donation-received', 'receive-payment'],
  },
  {
    slug: 'bad-debt-recovery',
    metaTitle: 'डूबत ऋण की वसूली की एंट्री — Dr/Cr | SahakarLekha',
    metaDescription: 'पहले अपलेखित (written-off) रकम अब वसूल होने का journal — Dr नकद/बैंक, Cr अशोध्य ऋण वसूली (आय)। सहकारी समिति उदाहरण सहित।',
    category: 'अनुदान व अन्य आय',
    title: 'डूबत ऋण वसूली (Bad Debt Recovery)',
    intent: 'doobat bad debt recovery entry',
    scenario: 'पहले जिसे डूबत मानकर अपलेखित (write-off) किया था, वह रकम अब वसूल हो गई।',
    lines: [
      { account: 'Cash / Bank (नकद / बैंक)', type: 'Dr' },
      { account: 'Bad Debt Recovery / अशोध्य ऋण वसूली (4409)', type: 'Cr' },
    ],
    narration: 'डूबत वसूली — ___ से पुरानी बकाया रकम प्राप्त',
    notes: [
      'यह आय है — पुराने अपलेखन (write-off) को उलटने के बजाय अलग आय खाते में दर्ज करना साफ़ रहता है।',
      'डूबत मानकर अपलेखन की उलटी एंट्री के लिए देखें: loan write-off।',
    ],
    deepLink: { route: '/receive-payment', label: 'App में वसूली दर्ज करें' },
    guideSlug: 'income-and-expenditure',
    related: ['loan-write-off', 'subsidy-received'],
  },
  {
    slug: 'donation-csr-paid',
    metaTitle: 'दान / CSR देने की एंट्री — Dr/Cr | SahakarLekha',
    metaDescription: 'समिति द्वारा दान या CSR व्यय का journal — Dr दान/CSR व्यय, Cr नकद/बैंक। सहकारी समिति के लिए उदाहरण सहित।',
    category: 'व्यय',
    title: 'दान / CSR दिया (Donation / CSR Paid)',
    intent: 'daan CSR diya entry',
    scenario: 'समिति ने किसी संस्था/कार्य को दान दिया या CSR के तहत खर्च किया।',
    lines: [
      { account: 'Donation / CSR — दान/CSR व्यय (5405)', type: 'Dr' },
      { account: 'Cash / Bank (नकद / बैंक)', type: 'Cr' },
    ],
    narration: 'दान/CSR — प्राप्तकर्ता ___, प्रस्ताव सं. ___',
    notes: [
      'बड़ा दान/CSR आम तौर पर प्रबंध समिति की मंज़ूरी से होता है — कार्यवृत्त का संदर्भ narration में रखें।',
    ],
    deepLink: { route: '/make-payment', label: 'App में भुगतान दर्ज करें' },
    guideSlug: 'income-and-expenditure',
    related: ['expense-paid', 'donation-received'],
  },
  {
    slug: 'donation-received',
    metaTitle: 'दान प्राप्त होने की एंट्री — Dr/Cr | SahakarLekha',
    metaDescription: 'समिति को दान मिलने का journal — Dr नकद/बैंक, Cr विविध आय (या दान-प्राप्त आय खाता)। सहकारी समिति उदाहरण सहित।',
    category: 'अनुदान व अन्य आय',
    title: 'दान प्राप्त (Donation Received)',
    intent: 'daan mila received entry',
    scenario: 'समिति को किसी व्यक्ति/संस्था से दान प्राप्त हुआ।',
    lines: [
      { account: 'Cash / Bank (नकद / बैंक)', type: 'Dr' },
      { account: 'Misc Income / विविध आय (4405)', type: 'Cr', note: 'चाहें तो "दान प्राप्त" नाम का अलग आय खाता बना लें' },
    ],
    narration: 'दान प्राप्त — दाता ___',
    notes: [
      'शर्त/उद्देश्य-बद्ध दान (जैसे किसी कोष के लिए) को उस विशेष कोष/निधि में रखना बेहतर, सामान्य आय में नहीं।',
    ],
    deepLink: { route: '/receive-payment', label: 'App में प्राप्ति दर्ज करें' },
    guideSlug: 'income-and-expenditure',
