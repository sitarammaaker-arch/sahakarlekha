...
export const HELP_TASKS: HelpTask[] = [
  ...
  {
    slug: 'view-balance-sheet',
    metaTitle: 'Balance Sheet कैसे देखें — सहकारी समिति | SahakarLekha',
    metaDescription: 'बैलेंस शीट खोलना, तारीख चुनना और संपत्ति = देनदारी + पूँजी का मिलान देखना — PDF डाउनलोड सहित। न मिलने पर सबसे पहले कहाँ देखें।',
    category: 'रिपोर्ट्स',
    title: 'Balance Sheet कैसे देखें',
    intent: 'balance sheet kaise dekhe',
    difficulty: 'beginner',
    estTime: '2 मिनट',
    tldr: 'Balance Sheet पेज खोलें → "as on" तारीख चुनें → एक ओर संपत्ति, दूसरी ओर देनदारी व पूँजी दिखेगी। दोनों बराबर होने चाहिए। PDF बटन से डाउनलोड करें।',
    steps: [
      'मेन्यू से **Balance Sheet** पेज खोलें।',
      'जिस तारीख की स्थिति चाहिए वह **"as on" तारीख** चुनें।',
      'एक ओर **संपत्ति** (नकद, बैंक, स्टॉक, ऋण, भवन) और दूसरी ओर **देनदारी व पूँजी** (जमा, उधार, शेयर पूँजी, रिज़र्व) दिखेगी।',
      'दोनों पक्ष **बराबर** होने चाहिए — यह बैलेंस शीट के "मिलने" का सबूत है।',
      '**PDF** बटन से समिति के नाम व हस्ताक्षर ब्लॉक सहित डाउनलोड करें।',
    ],
    commonMistakes: [
      'बैलेंस शीट न मिलने पर घबराना — सबसे पहले Opening Balances में कुल Dr = कुल Cr जाँचें; ज़्यादातर अंतर वहीं से आता है।',
      'क्लोज़िंग स्टॉक का दो बार गिना जाना — इससे संपत्ति पक्ष बढ़ जाता है।',
    ],
    faqs: [
      { q: 'बैलेंस शीट अपने-आप बनती है?', a: 'हाँ — आपके vouchers व ओपनिंग बैलेंस से यह अपने-आप बनती है; अलग से भरने की ज़रूरत नहीं।' },
      { q: 'दोनों पक्ष क्यों बराबर होते हैं?', a: 'क्योंकि हर लेन-देन दोहरी-एंट्री (Dr=Cr) से दर्ज होता है — इसलिए संपत्ति = देनदारी + पूँजी हमेशा टिका रहता है।' },
    ],
    deepLink: { route: '/balance-sheet', label: 'SahakarLekha में Balance Sheet देखें' },
    guideSlug: 'balance-sheet',
    related: ['view-trial-balance', 'view-profit-loss', 'opening-balances'],
  },
  {
    slug: 'view-profit-loss',
    metaTitle: 'आय-व्यय / Profit & Loss कैसे देखें — सहकारी समिति | SahakarLekha',
    metaDescription: 'आय-व्यय (लाभ-हानि) खाता खोलना, अवधि चुनना और शुद्ध लाभ/घाटा देखना — PDF सहित। यह vouchers से अपने-आप बनता है।',
    category: 'रिपोर्ट्स',
    title: 'आय-व्यय (P&L) कैसे देखें',
    intent: 'profit loss kaise dekhe',
    difficulty: 'beginner',
    estTime: '2 मिनट',
    tldr: 'Profit & Loss पेज खोलें → अवधि चुनें → कुल आय, कुल व्यय और शुद्ध लाभ/घाटा दिखेगा। यह vouchers से अपने-आप बनता है। PDF से डाउनलोड करें।',
    steps: [
      'मेन्यू से **Profit & Loss (आय-व्यय)** पेज खोलें।',
      'जिस अवधि का हिसाब चाहिए वह **तारीख-सीमा** चुनें।',
      'ऊपर **आय** (ब्याज, अनुदान, अन्य कमाई) और नीचे **व्यय** (वेतन, किराया, ब्याज आदि) दिखेंगे।',
      'सबसे नीचे **शुद्ध लाभ या घाटा** दिखता है — यही साल भर का परिणाम है।',
      '**PDF** बटन से डाउनलोड करें।',
    ],
    commonMistakes: [
      'लाभ-वितरण से पहले शुद्ध लाभ न जाँचना — पहले P&L का शुद्ध लाभ पक्का करें, फिर वितरण करें।',
      'खरीद-बिक्री समिति में Trading A/c के ग्रॉस प्रॉफ़िट को अनदेखा करना — वह पहले बनता है, फिर P&L में आता है।',
    ],
    faqs: [
      { q: 'आय-व्यय और Trading A/c में फ़र्क?', a: 'Trading A/c सिर्फ़ माल से ग्रॉस प्रॉफ़िट दिखाता है; आय-व्यय उसमें बाकी आय जोड़ और सारे खर्च घटाकर शुद्ध लाभ/घाटा निकालता है।' },
      { q: 'क्या यह अपने-आप बनता है?', a: 'हाँ — आपके vouchers से; अलग से कुछ भरना नहीं पड़ता।' },
    ],
    deepLink: { route: '/profit-loss', label: 'SahakarLekha में आय-व्यय देखें' },
    guideSlug: 'income-and-expenditure',
    related: ['view-balance-sheet', 'distribute-profit', 'view-trial-balance'],
  },
  {
    slug: 'view-day-book',
    metaTitle: 'Day Book कैसे देखें — दैनिक बही सहकारी समिति | SahakarLekha',
    metaDescription: 'किसी दिन/अवधि के सारे vouchers एक जगह देखना — तारीख चुनें, हर एंट्री जाँचें। Day Book vouchers से अपने-आप बनती है।',
    category: 'रिपोर्ट्स',
    title: 'Day Book कैसे देखें',
    intent: 'day book kaise dekhe',
    difficulty: 'beginner',
    estTime: '2 मिनट',
    tldr: 'Day Book पेज खोलें → तारीख या अवधि चुनें → उस दौरान के सारे vouchers (receipt/payment/journal/contra) क्रम से दिखेंगे। यह अपने-आप बनती है।',
    steps: [
      'मेन्यू से **Day Book (दैनिक बही)** पेज खोलें।',
      'जिस दिन/अवधि की एंट्रियाँ देखनी हैं वह **तारीख-सीमा** चुनें।',
      'उस दौरान के **सारे vouchers** — प्रकार, खाता, राशि व विवरण सहित — क्रम से दिखेंगे।',
      'किसी एंट्री पर क्लिक कर उसका पूरा voucher खोल/जाँच सकते हैं।',
    ],
    commonMistakes: [
      'Day Book को हाथ से बदलने की कोशिश — यह सिर्फ़ दिखाती है; सुधार उसी voucher में जाकर करें।',
    ],
    faqs: [
      { q: 'Day Book और Ledger में फ़र्क?', a: 'Day Book तारीख के क्रम से सारी एंट्रियाँ दिखाती है; Ledger एक खाते की सारी एंट्रियाँ एक जगह।' },
    ],
    deepLink: { route: '/day-book', label: 'SahakarLekha में Day Book देखें' },
    guideSlug: 'daybook-and-ledger',
    related: ['view-ledger', 'first-voucher', 'cash-book'],
  },
  {
    slug: 'view-ledger',
    metaTitle: 'Ledger (खाता-बही) कैसे देखें — सहकारी समिति | SahakarLekha',
    metaDescription: 'किसी एक खाते की सारी आवक-जावक और चलता बैलेंस देखना — खाता चुनें, अवधि चुनें, PDF डाउनलोड करें।',
    category: 'रिपोर्ट्स',
    title: 'Ledger (खाता-बही) कैसे देखें',
    intent: 'ledger kaise dekhe',
    difficulty: 'beginner',
    estTime: '2 मिनट',
    tldr: 'Ledger पेज खोलें → खाता चुनें → अवधि चुनें → उस खाते की हर Dr/Cr एंट्री व चलता बैलेंस दिखेगा। PDF से डाउनलोड करें।',
    steps: [
      'मेन्यू से **Ledger (खाता-बही)** पेज खोलें।',
      'जिस **खाते** का ब्योरा चाहिए वह चुनें (जैसे किसी सदस्य, आपूर्तिकर्ता या खर्च खाता)।',
      '**तारीख-सीमा** चुनें।',
      'उस खाते की हर **Dr/Cr एंट्री** और साथ में **चलता बैलेंस** दिखेगा।',
      '**PDF** बटन से डाउनलोड करें।',
    ],
    commonMistakes: [
      'गलत खाता चुनकर "बैलेंस गलत है" समझ लेना — पहले सही खाता व अवधि जाँचें।',
    ],
    faqs: [
      { q: 'किसी सदस्य/पार्टी का बकाया कैसे देखें?', a: 'उसका खाता Ledger में चुनें — नीचे का बैलेंस ही उसका बकाया/जमा है।' },
    ],
    deepLink: { route: '/ledger', label: 'SahakarLekha में Ledger देखें' },
    guideSlug: 'daybook-and-ledger',
    related: ['view-day-book', 'view-trial-balance'],
  },
  {
    slug: 'share-certificate',
    metaTitle: 'Share Certificate कैसे निकालें — शेयर रजिस्टर | SahakarLekha',
    metaDescription: 'सदस्य की शेयर पूँजी देखना और शेयर प्रमाणपत्र (share certificate) निकालना — शेयर रजिस्टर से, PDF सहित।',
    category: 'सदस्य व शेयर',
    title: 'Share Certificate कैसे निकालें',
    intent: 'share certificate kaise nikale',
    difficulty: 'beginner',
    estTime: '3 मिनट',
    tldr: 'Share Register पेज खोलें → सदस्य चुनें → उसकी शेयर संख्या व पूँजी दिखेगी → Share Certificate / PDF बटन से प्रमाणपत्र निकालें।',
    prerequisites: [
      { label: 'सदस्य व उसकी शेयर पूँजी पहले जुड़ी हो', slug: 'add-member' },
    ],
    steps: [
      'मेन्यू से **Share Register (शेयर रजिस्टर)** पेज खोलें।',
      'सूची में **सदस्य** ढूँढें — उसकी शेयर संख्या, राशि व तारीख दिखेगी।',
      'शेयर पूँजी सही न हो तो पहले Members पेज से सुधारें (यहाँ यह अपने-आप जुड़ती है)।',
      '**Share Certificate / प्रमाणपत्र** या **PDF** बटन दबाएँ।',
      'प्रमाणपत्र समिति व सदस्य विवरण सहित डाउनलोड हो जाता है।',
    ],
    commonMistakes: [
      'शेयर संख्या सीधे रजिस्टर में बदलने की कोशिश — शेयर पूँजी Members/receipt से जुड़ती है; वहीं से सुधारें।',
    ],
    faqs: [
      { q: 'शेयर पूँजी यहाँ से बदल सकते हैं?', a: 'सीधे नहीं — यह सदस्य की शेयर पूँजी entry से जुड़ती है, ताकि रजिस्टर और लेखा एक जैसे रहें।' },
      { q: 'नए सदस्य का प्रमाणपत्र कब मिलेगा?', a: 'सदस्य जुड़ते (और अप्रूव होते) ही उसकी शेयर पूँजी रजिस्टर में आ जाती है, फिर प्रमाणपत्र निकाल सकते हैं।' },
    ],
    deepLink: { route: '/share-register', label: 'SahakarLekha में Share Certificate निकालें' },
    guideSlug: 'member-management',
    related: ['add-member', 'distribute-profit'],
  },
  {
    slug: 'distribute-profit',
    metaTitle: 'लाभ वितरण (Profit Distribution) कैसे करें — सहकारी समिति | SahakarLekha',
    metaDescription: 'साल के शुद्ध लाभ को रिज़र्व फंड, लाभांश व अन्य निधियों में बायलॉज़ अनुसार बाँटना — appropriation voucher सहित।',
    category: 'वर्ष-अंत',
    title: 'लाभ वितरण (Profit Distribution) कैसे करें',
    intent: 'labh vitran kaise kare',
    difficulty: 'advanced',
    estTime: '5 मिनट',
    tldr: 'Profit Distribution पेज खोलें → शुद्ध लाभ अपने-आप आता है → रिज़र्व फंड, लाभांश व अन्य निधियों में बायलॉज़ अनुसार बाँटें → सेव। appropriation voucher बन जाता है।',
    prerequisites: [
      { label: 'साल बंद (year-end) की ओर बढ़ें व शुद्ध लाभ पक्का कर लें', slug: 'view-profit-loss' },
    ],
    steps: [
      'मेन्यू से **Profit Distribution (लाभ वितरण)** पेज खोलें।',
      'साल का **शुद्ध लाभ** अपने-आप आ जाता है (आय-व्यय से)।',
      'अपनी समिति की **उपविधि (bye-laws)** अनुसार हिस्से भरें — रिज़र्व फंड, सहकारी शिक्षा निधि, लाभांश आदि।',
      'बचा हुआ अधिशेष अगले साल आगे बढ़ता (carry-forward) है।',
      '**सेव** करें — वितरण का appropriation voucher अपने-आप बन जाता है।',
    ],
    commonMistakes: [
      'रिज़र्व फंड में क़ानूनी न्यूनतम हिस्सा डालना भूल जाना — यह उपविधि/अधिनियम अनुसार अनिवार्य होता है (दर राज्य अनुसार)।',
      'घाटे के साल में वितरण करना — घाटा हो तो वितरण नहीं होता; वह आगे समायोजित होता है।',
    ],
    faqs: [
