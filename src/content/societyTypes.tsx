...
export const SOCIETY_TYPES: SocietyType[] = [
  {
    ...
    metaDescription: 'PACS (प्राथमिक कृषि ऋण समिति) के लिए मुफ़्त लेखा सॉफ्टवेयर — सदस्य ऋण, KCC, ब्याज, NPA, DCCB/NABARD रिपोर्ट, आरक्षित निधि (धारा 65), ऑडिट। हिंदी+English।',
    ...
    painsHi: [
      ...
      'NPA वर्गीकरण व आरक्षित निधि का अनुपालन',
    ],
    solvesHi: [
      'ऋण रजिस्टर (धारा 32) — सदस्य-वार ऋण, किस्त व ब्याज स्वतः',
      'समर्पित KCC मॉड्यूल व ब्याज गणना',
      'NABARD रिपोर्ट + आरक्षित निधि (धारा 65) स्वतः',
      'सदस्य अंश रजिस्टर, ट्रायल बैलन्स, बैलेंस शीट व ऑडिट प्रमाणपत्र',
    ],
  },
  {
    slug: 'dairy',
  ...
  },
  {
    ...
    metaDescription: 'उपभोक्ता सहकारी भंडार के लिए मुफ़्त लेखा व इन्वेंट्री सॉफ्टवेयर — GST बिक्री बिल, स्टॉक मूल्यांकन, HSN/GSTR सारांश, आपूर्तिकर्ता बकाया व ऑडिट। हिंदी+English।',
  ...
  },
  {
    ...
    painsHi: [
      ...
      'चीनी/शीरा का स्टॉक व मूल्यांकन',
