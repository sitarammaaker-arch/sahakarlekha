/**
 * FAQ content — bilingual (Hindi + English) Q&A, the single source of truth used by
 * both the /faq page (FAQ.tsx) and the site-wide search index (siteSearch.ts).
 * Moved out of the page component so a lib (search) never has to import a page.
 */
