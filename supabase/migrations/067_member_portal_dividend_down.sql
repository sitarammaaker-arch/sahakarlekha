-- Rollback for 067_member_portal_dividend.sql - restores the 065 member_portal_snapshot()
-- (everything except the dividend keys). The portal keeps working; the dividend section goes away.
begin;
