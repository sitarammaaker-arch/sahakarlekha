...
**Why it matters:** It is the most common way beginners learn to make correct entries — a stepping stone before relying on the software's automation.

**Common misconceptions:**
- ❌ "There is one rule for everything." → There are three, by account type.
- ❌ "Software made the golden rules obsolete." → They still explain *why* an entry is the way it is.

**Related concepts:** [[KI-000027]] Debit · [[KI-000028]] Credit · [[KI-000033]] Account · [[KI-000026]] Double-entry system
...
- Understand the overview frames (not replaces) the three detailed rules.
