...
**Why it matters:** A recorded nominee avoids disputes and delays when a member dies. Societies maintain a nomination register for this.

**Common misconceptions:**
- ❌ "A nominee automatically becomes a member." → Nomination concerns receiving dues; membership follows the byelaws/rules.
- ❌ "Nomination can't be changed." → A member can usually update their nominee.

**Related concepts:** [[KI-000064]] Nomination (planned) · [[KI-000131]] Membership · [[KI-000004]] Member
...
**Suggested downloadable asset:** — (nomination form is a separate, validation-needed item)
**Suggested calculator:** — (not applicable)
**Suggested software module:** /nomination-register · /members

**Search intent:** informational — "nominee meaning cooperative / नॉमिनी"
**User persona:** SEC, MEM
**Learning objectives:**
- Define a nominee.
- Explain why recording a nominee matters.
